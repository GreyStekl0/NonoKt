...
name: material-3
description: >
  Material Design 3 implementation skill for web (@material/web), Flutter, and Jetpack Compose. Includes tokens, components, responsive layouts, theming, and MD3 compliance audit workflow.
---
...
When running in audit mode, or when asked to audit/review MD3 compliance, analyze the target app or page and produce a compliance report.
...
- Navigate to the page with browser tool
- Read the page DOM with browser tool
- Extract CSS custom properties with browser tool
- Check computed styles for MD3 token usage
- Test responsive behavior by resizing with browser tool
