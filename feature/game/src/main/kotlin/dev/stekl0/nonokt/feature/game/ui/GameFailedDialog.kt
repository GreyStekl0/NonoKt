...
internal fun GameFailedDialog(
    ...
    GameOutcomeDialogScaffold(
        title = R.string.feature_game_failure_title,
        testTag = "game_failed_dialog",
        minHeight = DialogMinHeight,
    ) {
        Text(
            text = stringResource(R.string.feature_game_failure_description),
        ...
        Row(
            ...
            Button(
                ...
                Text(text = stringResource(R.string.feature_game_failure_restart))
            }
        }
    }
}
